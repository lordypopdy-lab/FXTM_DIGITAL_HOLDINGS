                            ...
                            <div className="row">
                                <div style={{ borderRadius: "0px" }} className="col-xl-6 p-2 col-sm-6">
                                    ...
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        ...
                                        <h5 onClick={() => handleCopy("19sY932BMVqbP9eP54qWsiYNBuFmy2eXgJ")}>bc1qd8x8mw8qvz5dy0gyknwsd...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
                                ...
                                <div className="col-xl-6 col-sm-6 grid-margin mt-5">
                                    <div style={{ border: "none", borderRadius: "9px" }} className="card card-gradient">
                                        <div className="card-body card-gradient">
                                        <h5 onClick={() => handleCopy("TKym8FK6kaLgKzGQnJx9oRmcWWYHYHdnx9")}>TEEdfYXuH8j7AUgVbBgok8vSqXs...<i style={{ cursor: "pointer" }} className="fas fa-copy text-warning m-1"></i></h5>
